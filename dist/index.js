...
class Moshimoshi {
    ...
    handleResponseError(error) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (error.response && error.response.status === 401) {
                ...
                const accessToken = (_a = this.storage.retrieve(exports.TokenType.ACCESS)) === null || _a === void 0 ? void 0 : _a.value;
                if (accessToken) {
    ...
    login(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.storage.save(accessToken, exports.TokenType.ACCESS);
                this.storage.save(refreshToken, exports.TokenType.REFRESH);
            }
            catch (error) {
                console.error('API call error:', error);
                throw error;
    ...
    buildRequest(endpoint) {
        ...
        const config = {
            ...
            url,
            headers: Object.assign({ 'Content-Type': endpoint.contentType || exports.ContentType.JSON }, endpoint.headers),
    ...
    getAccessToken() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const accessToken = this.storage.retrieve(exports.TokenType.ACCESS);
                if (accessToken) {
                    if (accessToken.isValid) {
                        return accessToken.value;
                    }
                    else {
                        const refreshToken = this.storage.retrieve(exports.TokenType.REFRESH);
                        if (refreshToken) {
                            yield this.refreshToken();
    ...
    refreshToken() {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            this.refreshEndpoint.body = Object.assign(Object.assign({}, this.refreshEndpoint.body), { refreshToken: (_a = this.storage.retrieve(exports.TokenType.REFRESH)) === null || _a === void 0 ? void 0 : _a.value });
            try {
...
class Endpoint {
    constructor(config) {
        ...
        this.contentType = config.contentType || exports.ContentType.JSON;
